        ...
        <div className="text-center space-y-5 w-full flex flex-col items-center">
          ...
          <div className="flex flex-col items-center gap-2 w-full max-w-xs">
            ...
            <button
              ...
              className="text-xs text-muted-foreground hover:text-primary transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-ring focus-visible:ring-offset-2"
            >
    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center px-4 pb-24 overflow-hidden">
      ...
      {zenMode && (
        <button
          ...
          className="fixed top-4 right-4 z-50 rounded-full bg-card/50 p-2 text-muted-foreground backdrop-blur-sm hover:text-foreground transition-opacity opacity-30 hover:opacity-100 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-ring focus-visible:ring-offset-2"
