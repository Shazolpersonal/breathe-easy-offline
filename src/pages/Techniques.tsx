...
export default function Techniques() {
  ...
  const handleCreateCustom = () => {
    const technique: BreathingTechnique = {
      ...
      description: t("techniques.customDescription"),
      benefits: [t("techniques.personalizedBenefit")],
      difficulty: "beginner",
      isCustom: true,
      phases: [
        { type: "inhale", duration: form.inhale, label: t("phase.inhale") },
        ...(form.hold1 > 0 ? [{ type: "hold" as const, duration: form.hold1, label: t("phase.hold") }] : []),
        { type: "exhale", duration: form.exhale, label: t("phase.exhale") },
        ...(form.hold2 > 0 ? [{ type: "hold-after-exhale" as const, duration: form.hold2, label: t("phase.hold-after-exhale") }] : []),
      ],
    ...
    <div className="min-h-screen px-4 pb-24 pt-12">
      <div className="mx-auto max-w-md">
            ...
            <DialogContent className="max-h-[85vh] overflow-y-auto">
              ...
              <div className="space-y-4 pt-2">
                <div>
                  ...
                  <Input value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} placeholder={t("techniques.namePlaceholder")} />
                </div>
                  ...
                  {pyramidEnabled && (
                    <>
                      ...
                      <div className="text-xs text-muted-foreground">
                        {t("techniques.pyramidPreview")} {pyramidPreview.join("s → ")}s
                      </div>
                    </>
                  )}
                </div>
        ...
        <div className="space-y-3">
          {[...PRESET_TECHNIQUES, ...customTechniques].map((tech) => (
            <TechniqueCard
              key={tech.id}
              technique={tech}
