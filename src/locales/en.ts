export const en: Record<string, string> = {
  ...
  "guide.techniquesIntro": "Muhurto Breath includes 5 scientifically-backed preset techniques. Each has a unique rhythm designed for specific outcomes.",
  ...
  "guide.streaksDesc": "Complete at least one session per day to build your streak. Your current and longest streaks are displayed on the Stats page. Streaks reset if you miss a day.",
  ...
  "guide.dailyChallengesDesc": "Three daily challenges appear on the Home screen (Easy, Medium, Hard). Complete all three for a +25 XP bonus. Challenges refresh daily and include goals like \"Breathe for 5 minutes\", \"Calm score > 70\", or \"Try a never-used technique\".",
