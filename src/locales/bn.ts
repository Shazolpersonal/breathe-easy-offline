export const bn: Record<string, string> = {
  ...
  "guide.techniquesIntro": "মুহূর্ত ব্রেথে ৫টি বিজ্ঞানসম্মত প্রিসেট কৌশল আছে। প্রতিটির একটি অনন্য ছন্দ নির্দিষ্ট ফলাফলের জন্য ডিজাইন করা।",
  ...
  "guide.difficultyDesc2": "মাঝারি কৌশল ১০টি মোট সেশনের পর এবং উন্নত ২৫টি সেশনের পর আনলক হয়।",

  // Sessions
  "guide.sessions": "সেশন ও বৈশিষ্ট্য",
  "guide.sessionFlow": "সেশন প্রবাহ",
  "guide.sessionFlowDesc": "কৌশল নির্বাচন → সময়কাল সেট → শুরু → ভিজ্যুয়াল শ্বাস গাইড অনুসরণ → সেশন সম্পন্ন → আপনার প্রশান্তি স্কোর, অর্জিত XP এবং মুড পরিবর্তন দেখুন।",
  "guide.zenMode": "জেন মোড",
  "guide.zenModeDesc": "F চাপুন বা জেন বোতামে ট্যাপ করুন সব UI লুকিয়ে শুধু শ্বাসের ভিজ্যুয়ালাইজেশনে মনোযোগ দিতে। বের হতে Esc চাপুন।",
  "guide.voiceGuidance": "ভয়েস গাইডেন্স",
  "guide.voiceGuidanceDesc": "সেটিংসে কথ্য সংকেত সক্রিয় করুন। ভয়েস ফেজের নাম, কাউন্টডাউন, মাইলস্টোন এবং উৎসাহ ঘোষণা করে। গতি, পিচ এবং ভলিউম কাস্টমাইজযোগ্য।",
  ...
  "guide.breathDetectionDesc": "মাইক্রোফোন-ভিত্তিক শ্বাস সনাক্তকরণ সক্রিয় করুন আপনার ছন্দের নির্ভুলতা মাপতে। সব প্রসেসিং ডিভাইসেই হয় — কোনো অডিও কখনও রেকর্ড বা পাঠানো হয় না।",
  "guide.heartRate": "হৃদস্পন্দন মনিটর",
  "guide.heartRateDesc": "পিছনের ক্যামেরায় আঙুলের ডগা রেখে হৃদস্পন্দন অনুমান করুন। অ্যাপটি শ্বাস সমন্বয় মাপে — আপনার হৃদস্পন্দন কতটা শ্বাসের ছন্দের সাথে মেলে।",
  ...
  "guide.streaks": "ধারা",
  "guide.streaksDesc": "আপনার ধারা তৈরি করতে প্রতিদিন অন্তত একটি সেশন সম্পন্ন করুন। আপনার বর্তমান এবং দীর্ঘতম ধারা পরিসংখ্যান পৃষ্ঠায় প্রদর্শিত হয়। একদিন বাদ দিলে ধারা রিসেট হয়।",
  ...
  "guide.dailyChallengesDesc": "হোম স্ক্রিনে তিনটি দৈনিক চ্যালেঞ্জ দেখা যায় (সহজ, মাঝারি, কঠিন)। তিনটি সম্পন্ন করলে +২৫ XP বোনাস। চ্যালেঞ্জ প্রতিদিন রিফ্রেশ হয় এবং \"৫ মিনিট শ্বাস নিন\", \"প্রশান্তি স্কোর > ৭০\", বা \"কখনও ব্যবহার না করা কৌশল চেষ্টা করুন\" এর মতো লক্ষ্য অন্তর্ভুক্ত।",
